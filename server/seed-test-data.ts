/**
 * Script per inizializzare il database con dati di test compatibili con lo schema attuale
 */
...
async function seedTestData() {
  try {
    ...
    if (existingStages.length === 0) {
      ...
      // Crea gli stage della pipeline
      const stages = [
        { name: "Lead", description: "Potenziale cliente", position: 1, color: "#6E56CF" },
        { name: "Qualifica", description: "Verifica dell'opportunità", position: 2, color: "#6E56CF" },
        { name: "Contatto", description: "Primo contatto con il cliente", position: 3, color: "#3E63DD" },
        { name: "Analisi", description: "Analisi dei bisogni", position: 4, color: "#3E63DD" },
        { name: "Proposta", description: "Proposta commerciale", position: 5, color: "#3E63DD" },
        { name: "Negoziazione", description: "Fase di negoziazione", position: 6, color: "#F29D38" },
        { name: "Chiuso vinto", description: "Opportunità vinta", position: 7, color: "#66C61C" },
        { name: "Chiuso perso", description: "Opportunità persa", position: 8, color: "#E5484D" },
      ];
