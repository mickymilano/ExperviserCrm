...
- Name: CRM Navigation Tests >> Calendar module navigation
- Location: /home/runner/workspace/tests/e2e/navigation.test.ts:103:3
...
```ts
   3 | // Helper function to test navigation for a module
   4 | async function testModuleNavigation(page, moduleName) {
   5 |   console.log(`Testing ${moduleName} module navigation...`);
   6 |   
   7 |   // Navigate to the module list page
