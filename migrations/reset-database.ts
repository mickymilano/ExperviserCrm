    ...
    const companiesData = [
      {
        ...
        status: "active",
        isActiveRep: true,
        companyType: "Independente",
        brands: ["ABC Consulting", "ABC Advisory"],
        channels: ["Retail", "Online"],
        productsOrServicesTags: ["Consulenza Strategica", "Digital Transformation", "Change Management"]
      },
      {
        ...
        status: "active",
        isActiveRep: false,
        companyType: "Franchisor Monomarca",
        brands: ["XYZ Food", "XYZ Express"],
        channels: ["Franchising", "Direct Retail"],
        productsOrServicesTags: ["Food & Beverage", "Restaurant Chain", "Fast Food"]
      }
    ];
