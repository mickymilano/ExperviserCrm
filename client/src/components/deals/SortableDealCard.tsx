...
export function SortableDealCard({ deal, getCompanyName, getContactName, onClick }: SortableDealCardProps) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    ...
    >
      <Card 
        className="mb-3 cursor-move border border-border hover:border-primary/30 hover:shadow-sm transition-all duration-150"
        onClick={onClick}
      >
